...
def test_nfpm_apk_filename_normalizes_to_alpine() -> None:
    ...
    nfpm = "data-boar_1.8.0-rc-r1_x86_64.apk"
    alpine = "data-boar-1.8.0-rc-r1.apk"
...
def test_normalize_nfpm_apk_renames_in_dir(tmp_path: Path) -> None:
    src = tmp_path / "data-boar_1.8.0-rc-r1_x86_64.apk"
    src.write_bytes(b"apk-stub\n")
    renamed = normalize_nfpm_apk_filenames(tmp_path)
    dest = tmp_path / "data-boar-1.8.0-rc-r1.apk"
...
def test_validate_and_checksums(tmp_path: Path) -> None:
    pkg = tmp_path / "data-boar_1.8.0-rc_amd64.deb"
...
def test_merge_native_packages_leaves_files_intact() -> None:
    ...
    merged = merge_native_packages(
        ...
        [
            {
                "name": "data-boar_1.8.0-rc_amd64.deb",
                "packager": "deb",
                "sha256": "cd" * 32,
            }
        ],
...
def test_maybe_gpg_sign_sums_skips_without_key(tmp_path: Path) -> None:
    ...
    sums.write_text("deadbeef  data-boar_1.8.0-rc_amd64.deb\n", encoding="utf-8")
        ...
        json.dumps(
            {
                "files": [],
                "native_packages": [
                    {"name": "data-boar_1.8.0-rc_amd64.deb", "sha256": "bb" * 32}
                ],
            }
        )
        + "\n",
