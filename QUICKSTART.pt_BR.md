...
**Aprofundar depois:** [docs/USAGE.pt_BR.md](docs/USAGE.pt_BR.md) (operador) · [docs/TECH_GUIDE.pt_BR.md](docs/TECH_GUIDE.pt_BR.md) (integrador) · [docs/pitch/INDEX.pt_BR.md](docs/pitch/INDEX.pt_BR.md) (narrativa por papel)
...
A mesma demo sem passo de venv se você já tem [uv](https://docs.astral.sh/uv/): **`uvx data-boar --demo`**.
...
3. Confira o relatório Excel / heatmap na pasta de saída configurada (padrão relativo ao config — ver [docs/USAGE.pt_BR.md](docs/USAGE.pt_BR.md)).
...
| Referência completa de flags e API | [docs/USAGE.pt_BR.md](docs/USAGE.pt_BR.md) |
| Arquitetura e conectores | [docs/TECH_GUIDE.pt_BR.md](docs/TECH_GUIDE.pt_BR.md) |
