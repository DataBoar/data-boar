...
| ------                                    | --------------                      | ---------------                                                       | -----                                                                                       |
| **GitHub private repo** (personal or org) | Invite-only; branch protection; 2FA | **Free** on personal; **Team ~$4/user/mo** (org)                      | Fits **`FabioLeitao/license-studio`** (private issuer repo); never push signing keys. |
