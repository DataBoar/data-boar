...
- **Cooldown:** os três ecossistemas acima definem **`cooldown: default-days: 7`** em [`.github/dependabot.yml`](../.github/dependabot.yml) — janela de quarentena de sete dias antes de propor uma versão recém-publicada.
