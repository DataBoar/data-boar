...
**Plugins de remediação Enterprise (L1):** parceiros implementam `RemediationPlugin` (`core/plugins/`) e registram sob YAML `remediation:` — veja **[PLUGIN_SDK.pt_BR.md](PLUGIN_SDK.pt_BR.md)** ([EN](PLUGIN_SDK.md)). Distinto dos **plugins YAML de padrões** (regex/ML/DL via [ADR-0052](adr/ADR-0052-yaml-plugin-system-centralized-schema.md)).
