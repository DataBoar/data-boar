...
- The **license issuance** tool source or binaries intended only for your team (maintain in the **private** [`DataBoar/license-studio`](https://github.com/DataBoar/license-studio) repository; see [docs/ops/LICENSE_STUDIO_SPINOUT.md](ops/LICENSE_STUDIO_SPINOUT.md)).
