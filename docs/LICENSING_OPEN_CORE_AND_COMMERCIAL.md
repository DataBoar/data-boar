...
| **Companion resources and adjacent apps**     | **Docker Hub** image naming (`fabioleitao/data_boar`, tags); future **public website** copy; **private** issuer tooling ([`FabioLeitao/license-studio`](https://github.com/FabioLeitao/license-studio) — separate private repo); other repos you cite in portfolio (e.g. infra demos) — clarify which are **product family** vs **personal**             | [DOCKER_SETUP.md](DOCKER_SETUP.md), [HOSTING_AND_WEBSITE_OPTIONS.md](HOSTING_AND_WEBSITE_OPTIONS.md); maintainer portfolio pointers under **Internal and reference** in [README.md](README.md); private runbooks |
...
- The **license issuance** tool source or binaries intended only for your team (maintain in the **private** [`FabioLeitao/license-studio`](https://github.com/FabioLeitao/license-studio) repository; see [docs/ops/LICENSE_STUDIO_SPINOUT.md](ops/LICENSE_STUDIO_SPINOUT.md)).
