...
| **compliance-sample-ukraine_pdp.yaml**         | Ukraine PDP Law 2297-VI (2010, amended 2023): GDPR-convergent (EU candidacy 2022); IPN (10-digit taxpayer ID) + biometric passport regex; **precise geolocation**; sensitive categories; 72 h breach notification; martial law context note; EN + UK.                                                                   |
