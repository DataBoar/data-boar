...
| **Selecionado**  | **S2a – Transporte + confiança (POC open core, pronto para demo)** — plano HTTPS **Fase 7** + fatia **trust-state** (**PLANS_TODO** ordens **4** / **4a**) **emparelhada** com governança **#86** (`/status`, doc de middleware **ou** alinhamento RBAC fino) | A/M | *Integration* **S2a** em [PLANS_TODO.md](PLANS_TODO.md); [PLAN_DASHBOARD_HTTPS_BY_DEFAULT_AND_HTTP_EXPLICIT_RISK.md](PLAN_DASHBOARD_HTTPS_BY_DEFAULT_AND_HTTP_EXPLICIT_RISK.md); [PLAN_GRC_INSPIRED_ENTERPRISE_TRUST_ACCELERATORS.md](PLAN_GRC_INSPIRED_ENTERPRISE_TRUST_ACCELERATORS.md); [PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md](PLAN_DASHBOARD_REPORTS_ACCESS_CONTROL.md) |
