# Governance and ITSM diagrams — source companion

**Status:** Active companion (diagram source for planned primers; not a standalone product doc).
...
O modelo Avaliar → Dirigir → Monitorar (EDM) da ISO/IEC 38500
descreve como a alta direção conduz o uso responsável da tecnologia.
O Data Boar opera como camada operacional de evidência em cada etapa.
