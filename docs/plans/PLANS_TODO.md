...
- **Wave 1 — sequenciamento explícito (v1.7.4 + v1.7.5-beta fase U0/U1):** Executar na ordem do issue #656. Parar após todos os itens da Fase 5 fechados. Não avançar para U2 sem instrução do operador.
