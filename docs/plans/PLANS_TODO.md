...
| [1337](https://github.com/DataBoar/data-boar/issues/1337) | SQL sampling dedup / recall-safe optimization | Performance / SQL | [PLAN_BENCHMARK_SAFE_AXIS.md](PLAN_BENCHMARK_SAFE_AXIS.md) | **`[H1][U2]`** — **NÃO INICIAR ANTES DE #1338 FECHADA** |
