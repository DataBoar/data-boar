...
- **Database compat matrix — sparse A×B (`#1237` / `#1302`, plan 2026-07-22):** Axis A = platform hosts (mini-bt, alpine-emachines, pi3b, T14/latitude — FS/CSV/SQLite); axis B = engines on T14 Podman farm (pg/mysql/mariadb/mssql/oracle/sqlite, mongo, redis) + separate cloud-lane; sparse intersections only for native drivers (pymssql/psycopg2/oracledb thick). alpine-emachines light client → remote T14 validates [#1237](https://github.com/DataBoar/data-boar/issues/1237) latency. Synthetic fixtures only. Tracking plan: [PLAN_DATABASE_COMPAT_MATRIX.md](PLAN_DATABASE_COMPAT_MATRIX.md). Cross-refs [#1171](https://github.com/DataBoar/data-boar/issues/1171), [#1182](https://github.com/DataBoar/data-boar/issues/1182), [#782](https://github.com/DataBoar/data-boar/issues/782)/GAP-001.
