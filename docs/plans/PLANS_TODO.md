...
- **Supply Colleague-Nn inventory (dependencies / image):** [ADR 0003](../adr/0003-sbom-roadmap-cyclonedx-then-syft.md), [SECURITY.md](../SECURITY.md) (SBOM filenames).
