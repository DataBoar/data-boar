...
| #   | To-do                                                                                                                                                                                                | Status                                                                                                                                                            |
| --- | --------------------------------------------------------------------------------------------------------------------------------                                                                     | ------                                                                                                                                                            |
| 1   | **Tier 1 – EPUB:** Add .epub to SUPPORTED_EXTENSIONS; extract text from OCF (ZIP) content documents; run scanner.                                                                                    | ✅ Done (`filesystem_connector.py`; `data_soup_formats.sample_epub_text`)                                                                                        |
| 2   | **Tier 1 – Parquet / Avro:** Add .parquet, .avro; read schema + sample rows; run scanner on column names and sample values.                                                                          | ✅ Done (`sample_parquet_text`, `sample_avro_text` in `connectors/data_soup_formats.py`)                                                                         |
