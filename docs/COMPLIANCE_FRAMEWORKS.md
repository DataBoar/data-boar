...
| **Ecuador (LOPDP — 2021)**    | [compliance-sample-ecuador_lopdp.yaml](compliance-samples/compliance-sample-ecuador_lopdp.yaml)             | Ley Orgánica de Protección de Datos Personales; APDP; contextual cédula/RUC/passport labels; migratory status as sensitive (Art. 23 — unusual among LatAm); precise geolocation (JSON lat/lng + CSV pair); children's data (Art. 35); 72h breach notification; GDPR-influenced; full enforcement May 2023; ES + EN. |
