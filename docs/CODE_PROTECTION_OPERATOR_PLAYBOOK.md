...
| **Issuer isolation** | A4 | Private repo [`DataBoar/license-studio`](https://github.com/DataBoar/license-studio); **never** push keys | [LICENSE_STUDIO_SPINOUT.md](ops/LICENSE_STUDIO_SPINOUT.md), checklist, `.gitignore` reminders |
...
> **Priority band A, step A4.** Issuer tooling lives in private **`DataBoar/license-studio`** (spun out 2026-06-25). See [docs/ops/LICENSE_STUDIO_SPINOUT.md](ops/LICENSE_STUDIO_SPINOUT.md): layout, `studio sign`, where keys live (never in git), link to [LICENSING_SPEC.md](LICENSING_SPEC.md). No keys, no real URLs with tokens.
