...
**Status:** **DRAFT / UNRELEASED** — **`main`** em **`1.7.4-rc-2`** até o **release gate** **#406** fechar. **#970** = bump/tag stable **prematuro** (sem gate — **ADR-0072**). **Sem** tag stable, GitHub Release, ou Docker Hub publish até semver definido.

**Semver stable + tag:** **TBD** pós-ratificação **ADR-0073** (Proposed) + fechamento **#406** — ver **#971**, **`docs/VERSIONING.md`**.
