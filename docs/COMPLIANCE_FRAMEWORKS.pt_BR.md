...
| **Ucrânia (Lei PDP 2297-VI)**  | [compliance-sample-ukraine_pdp.yaml](compliance-samples/compliance-sample-ukraine_pdp.yaml)                 | Lei 2297-VI (2010, emendada 2023); convergência GDPR (candidatura UE 2022); regex IPN (10 dígitos) + passaporte biométrico; **geolocalização precisa**; categorias sensíveis; notificação de violação em 72 h; contexto de lei marcial; EN + UK. |
