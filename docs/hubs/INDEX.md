...
| Ops hub | `docs/hubs/OPS_HUB.md` | Generated index of tracked Markdown files in the ops folder |
| Guidelines and guardrails | `docs/hubs/GUIDELINES_AND_GUARDRAILS_HUB.md` | Hard rules, ops guidelines, Safe-Hold (index only) |
| Shorthands and wrappers | `docs/hubs/SHORTHANDS_HUB.md` | Lab/session shorthands + PS1/`.sh` gap audit |
