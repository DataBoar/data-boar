...
_Gerado por `scripts/build_ops_hub.py` — **401** arquivos Markdown, **220** stems (EN e pt-BR na mesma linha). Tabelas canônicas no arquivo em inglês (nomes de arquivo permanecem em inglês para bater com o disco)._
