...
| ------                                      | --------------                          | ---------------                                                            | -----                                                                                                          |
| **Repo privado no GitHub** (pessoal ou org) | Só por convite; proteção de branch; 2FA | **Grátis** no pessoal; **Team ~US$ 4/usuário/mês** (org)                   | Serve para o emissor privado **`DataBoar/license-studio`**; nunca envie chaves de assinatura. |
