...
- **ISO/IEC 27701** (**Colleague-KS**): privacy extension aligned with declared regulations (e.g. **LGPD**, **GDPR**); product-facing detail in [Auditable and management standards (supporting role)](COMPLIANCE_FRAMEWORKS.md#auditable-and-management-standards-supporting-role) under [COMPLIANCE_FRAMEWORKS.md](COMPLIANCE_FRAMEWORKS.md).
