...
You still get a **single workspace** in Cursor: **`data-boar/`** (clone of **DataBoar/data-boar**) with **`docs/private/`** inside it—only **two** Git histories if you choose to init the inner repo.
