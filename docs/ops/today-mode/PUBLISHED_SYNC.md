...
| ----- | ----- |
| **Verified** | **2026-08-18** |
| **`pyproject.toml` on `main`** | **`1.8.0-rc`** (`maturity_build=127`) — `1.8.0` release-candidate line (ADR-0073). Git-only for consumers; **not** on PyPI/Hub. |
...
| **Next publishable** | Stable **`1.8.0`** per [VERSIONING.md](../VERSIONING.md) + ADR-0072/0073 (release-ritual) |
