...
| ---- | ------ | ------ | ----- |
| **Lab-op observability plan Status drift (#1542)** | Lab session **2026-08-11→12** · [PLAN_LAB_OP_OBSERVABILITY_STACK.md](../../plans/PLAN_LAB_OP_OBSERVABILITY_STACK.md) · [OPERATOR_TODAY_MODE_2026-08-12.md](OPERATOR_TODAY_MODE_2026-08-12.md) | 🔄 Almost ready (docs) | Lab receivers/PDC/filelog fixes done in private lab; **plan `Status:` still stale**. Thin docs PR per [#1542](https://github.com/DataBoar/data-boar/issues/1542) AC — Phase D (Graylog) **not** adopted. |
| **Product OTel gaps — LoggerProvider + CLI oneshot** | [#1529](https://github.com/DataBoar/data-boar/issues/1529) · [#1535](https://github.com/DataBoar/data-boar/issues/1535) | ⬜ Pending | After lab log path trusted: LoggerProvider→Loki; then oneshot CLI/export visibility. Related: Maestro OTel trust [#1540](https://github.com/DataBoar/data-boar/issues/1540). |
| **Native packages plan linkage (#1541) + Windows CI (#1427)** | [#1541](https://github.com/DataBoar/data-boar/issues/1541) · [#1427](https://github.com/DataBoar/data-boar/issues/1427) · [#1467](https://github.com/DataBoar/data-boar/issues/1467) | 🔄 #1541 in PR; #1427 still open | Docs/ADR PR for #1541; Windows `windows-latest` job (#1427) still blocks MSI/winget (#1467). |
...
| **Maestro private repo — phase-1 migration** | `FabioLeitao/maestro` · `docs/ops/CURSOR_ECOSYSTEM_ONBOARDING.md` | ✅ Done | **PR #9** `feat/phase1-migrate-from-data-boar` (ADR-0001) **merged 2026-07-20** (`DataBoar/maestro`). **PR #7** docs skeleton. Public **#786** shipped via **#787**. Residual (not this row): `.ps1` handlers may still live under **`data-boar/scripts/maestro*`** until further cutover — see ecosystem onboarding. |
...
| **Dependabot queue (`deps`) — land or supersede locally** | `gh pr list` **2026-08-12** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | 🔄 In progress | **Open (refresh):** **#1492** virtualenv · **#1487** reportlab 5 · **#1485** webauthn 3 · **#1484** pyarrow 25. Triage with skill — **no blind merge.** Older RED list in history may be closed/superseded; re-check `gh pr list` before acting. |
