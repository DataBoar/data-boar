...
| ---- | ------ | ------ | ----- |
| **data-boar-site [#55](https://github.com/DataBoar/data-boar-site/pull/55) — FAQ SEO** | Session **2026-08-07** · post–Actions outage | ⬜ Await merge | CI **green** (guardrails link-rel / `canonical` fix). **HITL merge** when ready. |
| **data-boar [#1476](https://github.com/DataBoar/data-boar/pull/1476) — ADR-0085 install priority ladder** | Session **2026-08-07** · `docs/adr/ADR-0085-…` | ⬜ Await merge | CI **green** (12/12; fixture + `INVENTORY` + MD009/MD034). **HITL merge** when ready. |
| **Rescue 6 rare ISOs — 3-2-1 copies** | Operator **2026-08-07** (evidence / archive) | ✅ Rescued | **Done:** durable 3-2-1 for **BICSI 1998**; **OpenSolaris 2008.05**; **TLS-6** install / source / companion / security-crypto. Inventory stays private — no paths/secrets in public tree. |
| **Double-tap A.I.I.D.C.O.B.P.P. v1.5** | Operator **2026-08-07** · ADR-0062 | ⬜ Pending | Two Claude↔Cursor pairs (mobile workstation role + L-series primary role; no hostnames in public docs). Pin models; no Auto. Close when both pairs finish or defer with date. |
