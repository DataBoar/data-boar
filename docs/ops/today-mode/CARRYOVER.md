...
| **Dependabot queue (`deps`) — land or supersede locally** | `gh pr list` **2026-08-12** EOD · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | 🔄 In progress | **Open:** **#1487** reportlab 5 · **#1485** webauthn 3 · **#1484** pyarrow 25. (**#1492** virtualenv merged.) Triage with skill — **no blind merge.** |
