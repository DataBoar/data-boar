...
| **Dependabot queue (`deps`) — land or supersede locally** | `gh pr list` **2026-08-17** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | ✅ Cleared (open queue) | **Merged 2026-08-17:** Actions **#1573** setup-python **7** · **#1487** reportlab **5** · **#1484** pyarrow **25** (earlier). **#1485** webauthn **3** → local signed supersede PR (Dependabot blocked by **required_signatures**). Re-open this row when new Dependabot PRs appear. |
