...
| **Dependabot queue (`deps`) — land or supersede locally** | `gh pr list` **2026-08-16** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | 🔄 In progress | **Actions:** **#1573** setup-python **7** (open — major). **Merged:** **#1574** codeql-action (**2026-08-16**) · **#1572** zizmor-action (**2026-08-15**). **Major uv (open):** **#1487** reportlab 5 · **#1485** webauthn 3 · **#1484** pyarrow 25. Triage with skill — **no blind merge.** |
