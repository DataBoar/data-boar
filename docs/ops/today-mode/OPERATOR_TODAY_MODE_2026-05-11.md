...
| **S1** | **Bandit Phase 3 closure** | **`-ll -ii`** gate green; low findings triaged; plan → **`completed/`** when done | [PLAN_BANDIT_SECURITY_LINTER.md](../../plans/PLAN_BANDIT_SECURITY_LINTER.md) |
