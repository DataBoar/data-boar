...
| ---- | ------ | ------ | ----- |
| **Drift de Status do plano de observability lab-op (#1542)** | Sessão lab **2026-08-11→12** · [PLAN_LAB_OP_OBSERVABILITY_STACK.md](../../plans/PLAN_LAB_OP_OBSERVABILITY_STACK.md) · [OPERATOR_TODAY_MODE_2026-08-12.pt_BR.md](OPERATOR_TODAY_MODE_2026-08-12.pt_BR.md) | 🔄 Quase pronto (docs) | Receivers/PDC/filelog feitos no lab; **`Status:` do plano ainda velho**. PR fino de docs per [#1542](https://github.com/DataBoar/data-boar/issues/1542) — Phase D (Graylog) **não** adotada. |
| **Gaps OTel de produto — LoggerProvider + oneshot CLI** | [#1529](https://github.com/DataBoar/data-boar/issues/1529) · [#1535](https://github.com/DataBoar/data-boar/issues/1535) | ⬜ Pendente | Depois do path de log do lab: LoggerProvider→Loki; depois visibilidade oneshot. Relacionado: [#1540](https://github.com/DataBoar/data-boar/issues/1540). |
| **Links do plano de packaging nativo (#1541) + CI Windows (#1427)** | [#1541](https://github.com/DataBoar/data-boar/issues/1541) · [#1427](https://github.com/DataBoar/data-boar/issues/1427) · [#1467](https://github.com/DataBoar/data-boar/issues/1467) | 🔄 #1541 em PR; #1427 ainda aberto | PR docs/ADR do #1541; job `windows-latest` (#1427) ainda bloqueia MSI/winget (#1467). |
...
| **Maestro repo privado — migração fase 1** | `FabioLeitao/maestro` · `docs/ops/CURSOR_ECOSYSTEM_ONBOARDING.md` | ✅ Feito | **PR #9** `feat/phase1-migrate-from-data-boar` (ADR-0001) **mergeado 2026-07-20** (`DataBoar/maestro`). **PR #7** skeleton. Público **#786** → **#787**. Residual (outra fila): handlers `.ps1` podem ainda viver em **`data-boar/scripts/maestro*`** até cutover — ver onboarding do ecossistema. |
...
| **Fila Dependabot (`deps`) — landar ou superseder local** | `gh pr list` **2026-08-12** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | 🔄 Em progresso | **Abertos (refresh):** **#1492** virtualenv · **#1487** reportlab 5 · **#1485** webauthn 3 · **#1484** pyarrow 25. Triage com skill — **sem merge às cegas.** Re-checar `gh pr list` antes de agir. |
