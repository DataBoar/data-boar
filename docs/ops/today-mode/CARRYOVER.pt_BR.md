...
| ---- | ------ | ------ | ----- |
| **#552 sink de achados — mergear PR #1816** | Sessão **2026-08-28** · [#552](https://github.com/DataBoar/data-boar/issues/552) · [PR #1816](https://github.com/DataBoar/data-boar/pull/1816) | 🔄 PR aberto | Mergear com CI verde (`Closes #552`). Correção SSRF da URL já na branch (`7d6eb387`). |
