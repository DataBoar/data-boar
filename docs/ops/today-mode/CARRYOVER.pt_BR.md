...
| **Fila Dependabot (`deps`) — landar ou superseder local** | `gh pr list` **2026-08-16** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | 🔄 Em progresso | **Actions:** **#1573** setup-python **7** (aberto — major). **Mergeados:** **#1574** codeql-action (**2026-08-16**) · **#1572** zizmor-action (**2026-08-15**). **Majors uv (abertos):** **#1487** reportlab 5 · **#1485** webauthn 3 · **#1484** pyarrow 25. Triage com skill — **sem merge às cegas.** |
