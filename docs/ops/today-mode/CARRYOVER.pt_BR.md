...
| ---- | ------ | ------ | ----- |
| **data-boar-site [#55](https://github.com/DataBoar/data-boar-site/pull/55) — FAQ SEO** | Sessão **2026-08-07** · pós-outage Actions | ⬜ Aguarda merge | CI **verde** (fix guardrails link-rel / `canonical`). **Merge HITL** quando pronto. |
| **data-boar [#1476](https://github.com/DataBoar/data-boar/pull/1476) — ADR-0085 install priority ladder** | Sessão **2026-08-07** · `docs/adr/ADR-0085-…` | ⬜ Aguarda merge | CI **verde** (12/12; fixture + `INVENTORY` + MD009/MD034). **Merge HITL** quando pronto. |
| **Resgate de 6 ISOs raras — cópias 3-2-1** | Operador **2026-08-07** (evidência / arquivo) | ✅ Resgatadas | **Feito:** 3-2-1 durável para **BICSI 1998**; **OpenSolaris 2008.05**; **TLS-6** install / source / companion / security-crypto. Inventário fica em privado — sem paths/segredos no tree público. |
| **Double-tap A.I.I.D.C.O.B.P.P. v1.5** | Operador **2026-08-07** · ADR-0062 | ⬜ Pendente | Dois pares Claude↔Cursor (papel workstation móvel + primary L-series; sem hostnames em docs públicos). Pin de modelos; sem Auto. Fechar quando ambos os pares terminarem ou adiar com data. |
