...
| **Fila Dependabot (`deps`) — landar ou superseder local** | `gh pr list` **2026-08-17** · skill **dependabot-recommendations** · ADR-0069 **`rpds-py<2026`** | ✅ Limpa (fila aberta) | **Mergeados 2026-08-17:** Actions **#1573** setup-python **7** · **#1487** reportlab **5** · **#1484** pyarrow **25** (antes). **#1485** webauthn **3** fechada como supersedida pelo PR assinado **[#1608](https://github.com/DataBoar/data-boar/pull/1608)** (Dependabot bloqueado por **required_signatures**). Reabrir esta linha quando novos PRs Dependabot aparecerem. |
