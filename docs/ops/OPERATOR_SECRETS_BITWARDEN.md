...
## Free tier vs paid (verify current plans on [bitwarden.com/pricing](https://bitwarden.com/pricing/))

**Third-party plans vs Data Boar:** Pointing at **Bitwarden’s own** pricing page (plans, limits, billing owner) is allowed. The rule “no public Data Boar pricing page” applies only to **this product** — not to a vendor’s published SKUs.
...
1. **Decide the billing owner** (one account creates or upgrades the org on [bitwarden.com/pricing](https://bitwarden.com/pricing/) — verify current plan names and limits).
