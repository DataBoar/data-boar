...
| NIST Privacy Framework + AI RMF | Função **Identify-P** (NIST PF) + **Privacy-Enhanced** (AI RMF) — posicionamento enterprise e inventário preventivo de PII em dados de treinamento. Detalhe: [WAZUH_NIST_CIS_LABOP_ALIGNMENT.pt_BR.md](WAZUH_NIST_CIS_LABOP_ALIGNMENT.pt_BR.md) ([EN](WAZUH_NIST_CIS_LABOP_ALIGNMENT.md)). Só alinhamento — não é certificação PF/RMF. |
