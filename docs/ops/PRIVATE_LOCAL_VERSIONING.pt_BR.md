...
No Cursor você continua com **um workspace** só: **`data-boar/`** (clone de **DataBoar/data-boar**) com **`docs/private/`** dentro—são **dois** históricos Git **só se** você fizer `git init` na pasta privada.
