...
| **Alpine musl / Void musl / no-AVX hosts** | Default path not frictionless | Use wheelhouse (`--find-links`) or distro build prerequisites; fall back to Docker when wheelhouse is unavailable |
