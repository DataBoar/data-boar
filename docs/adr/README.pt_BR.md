...
| 0078 | [Multi-pattern regex: RegexSet before Vectorscan (benchmark gate; #1415 amend — premissa falsa CLI/prefilter corrigida; spike RegexSet falhou; próximo = Regex cacheado; status Proposed)](ADR-0078-multi-pattern-regex-benchmark-gate-regexset-before-vectorscan.md) | Proposto |
