...
| **Issuance**          | Private issuer ([`FabioLeitao/license-studio`](https://github.com/FabioLeitao/license-studio) — operator-only) issues different token **templates** per SKU; audit log records program/tier. |             |                                                                                                   |
