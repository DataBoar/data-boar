...
# 2.1 Puxa todos os logs da pasta ~/log/ do nó para a nova pasta no primary Windows dev workstation (L-series), renomeando com Host + Timestamp para não sobrescrever o histórico
