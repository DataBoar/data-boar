...
| [build-nogil-local.sh](build-nogil-local.sh) | Local **cp314t** image build + ACs (interpreter GIL, license gate, `--demo`, in-container `/health`, PID 1 `PYTHON_GIL` via `/proc/1/environ`). No Hub push. |
