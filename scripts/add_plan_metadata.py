...
KNOWN_DEPS: dict[str, str] = {
    ...
    "PLAN_SYNTHETIC_DATA_LAB.md": "ADR-0007",
    "PLAN_IMAGE_SENSITIVE_DATA_DETECTION.md": "ADR-0012",
    "PLAN_IMAGE_SENSITIVE_DATA_DETECTION.pt_BR.md": "ADR-0012",
...
PRIORITY_OVERRIDES: dict[str, str] = {
    ...
    "PLAN_FOUNDER_SRE_CAREER_AND_PRODUCT_ALIGNMENT.pt_BR.md": "H1",
    "PLAN_FOUNDER_CAREER_AND_BRANDING.md": "H1",
    ...
    "PLAN_IMAGE_SENSITIVE_DATA_DETECTION.md": "H3",
    ...
    "PLAN_WEB_GUI_DESIGN_SYSTEM_EVOLUTION.md": "H3",
